...
## 18g. Sprachausgabe: Qualität sicherstellen

**Problem:** Die Sprachausgabe im Hörverständnis-Format nutzt die Stimme des jeweiligen Geräts/Browsers. Deren Qualität schwankt stark, ist oft schlecht (bestätigt beim ersten Test) und auf manchen Geräten fehlt eine deutsche Stimme komplett – dann funktioniert das Format dort gar nicht. Für eine Sprachlern-App ist das gravierend: Bei schlechter Aussprache lernen die Nutzer eine falsche Aussprache, und genau das Sprechen mit Gästen ist ja das eigentliche Kursziel.

**Kurzfristig – beste verfügbare Stimme wählen:** Browser bieten häufig mehrere deutsche Stimmen an; die netzbasierten Google-Stimmen klingen deutlich besser als lokale Windows-Stimmen. Die App soll gezielt die beste verfügbare deutsche Stimme auswählen, statt einfach die erste gefundene zu nehmen.

**Langfristig – vorproduzierte Audiodateien (die eigentliche Lösung):** Beim Einpflegen der echten Inhalte wird für jeden Hörverständnis-Satz **einmalig vorab** eine Audiodatei erzeugt (z. B. mit Google Cloud Text-to-Speech, Neural2-Stimmen) und fest mit der App ausgeliefert – **genau wie bereits bei der Schriftart und den Sound-Effekten gehandhabt** (lokal gebündelt, nicht zur Laufzeit nachgeladen).

**Wichtig gegen ein naheliegendes Missverständnis:** Der Cloud-TTS-Dienst ist dabei nur ein **einmaliges Werkzeug beim Erstellen der Inhalte** und wird zur Laufzeit nie aufgerufen. Es entsteht dadurch **keine** Internet-Abhängigkeit im Betrieb und **keine** laufenden Kosten. Der Ansatz stärkt das Offline-First-Prinzip, statt ihm zu widersprechen.

- Gleiche, gute Qualität auf jedem Gerät
- Funktioniert offline – wichtig für das Schiffsszenario
- Kein Ausfall, wenn auf einem Gerät keine gute deutsche Stimme installiert ist
- **Kosten vernachlässigbar:** 1 Mio. Zeichen pro Monat kostenlos, danach 16 $ pro Million. 1.000 Sätze à 60 Zeichen sind 60.000 Zeichen – also weit im kostenlosen Bereich, und die Erzeugung erfolgt nur einmal.
- **Ehrlicher Gegenpunkt:** Das Erzeugen und Pflegen vorproduzierter Dateien für einen wachsenden Fragenkatalog bedeutet mehr einmaligen Aufwand als der bereits umgesetzte Code-Fix. Deshalb zurückgestellt, bis sich zeigt, ob die kurzfristige Lösung (beste verfügbare Systemstimme) in der Praxis ausreicht.
